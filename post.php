...
include 'auth.php';
$a=104;
$passion_july = mysqli_query($con,"SELECT * FROM passion_july ORDER BY id ASC"); 
...
<div class="row ">
<?php
while($row=mysqli_fetch_array($passion_july)){
?>
<div class="col-md-4 zoom pb-5">
<div class="card-deck">
<div class="card">
<img class="card-img-top" style="height:270px;" src="images/services/passion-july/<?php echo $row['img']; ?>" alt="Pending"> 
</div>
</div>
</div>
