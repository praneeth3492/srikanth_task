...
$today = date("D d M Y");
$edit = $_GET['edit'];
$resultt = mysqli_query($con,"SELECT * FROM july where id='$edit'");
...
$folder = "images/services/july/".$lis_img;
if($edit==''){

move_uploaded_file($tempname, $folder);

$insertdata = mysqli_query($con,"INSERT INTO july(date,imageremarks,supporting_text,remarks,img)VALUES('$date','$imageremarks','$supporting_text','remarks','$lis_img')");
echo "<script>alert('Posted Successfully');</script>
<script>window.location.href = 'july_add.php'</script>";
}
else{
move_uploaded_file($tempname, $folder);

$insertdata = mysqli_query($con,"UPDATE july SET date='$date',supporting_text='$supporting_text',imageremarks='$imageremarks',remarks='$remarks',img='$lis_img' where id=".$edit."");
