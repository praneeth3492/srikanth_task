...
include 'auth.php';
$a=200;
$august = mysqli_query($con,"SELECT * FROM august ORDER BY id ASC"); 
...
<div class="row ">
<?php
while($row=mysqli_fetch_array($august)){
?>
<div class="col-md-4 zoom pb-5">
<div class="card-deck">
<div class="card">
<img class="card-img-top" style="height:270px;" src="images/services/august/<?php echo $row['img']; ?>" alt="Pending"> 
</div>
</div>
</div>
